...
registerCommand('قسم_عام', async (ctx) => {
    try {
        const targetCategories = ['⚙️ عام', '🛡️ حماية وإدارة', '👑 المالك'];
        ...
        let text = `✨ ───『 *أوامر القسم العام والإدارة والمالك ⚙️* 』─── ✨\n\n`;
    ...
    description: 'عرض أوامر القسم العام والإدارة والمالك بشكل نصي منسق',
    category: '⚙️ عام'
});
