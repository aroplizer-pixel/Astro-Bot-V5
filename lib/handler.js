...
export async function handleMessage(sock, msg) {
            ...
            try {
                ...
                if (groupDb.antiDelete) {
                    ...
                    if (originalMsg) {
                        ...
                        let deletedSenderNumber = cleanDeletedSender.split('@')[0];
                        if (cleanDeletedSender.endsWith('@lid') && altDeletedSender && altDeletedSender.endsWith('@s.whatsapp.net')) {
                            deletedSenderNumber = altDeletedSender.split('@')[0].split(':')[0];
                        }
    ...
    if (sender.endsWith('@lid') && altSender && altSender.endsWith('@s.whatsapp.net')) {
        senderNumber = altSender.split('@')[0].split(':')[0];
    }
