                    ...
                    if (hasLink) {
                        ...
                        if (warnings >= 3) {
                            if (isBotAdmin) {
                                ...
                                await sock.sendMessage(from, {
                                    text: `🛡️ تم طرد @${senderNumber} لتكرار إرسال روابط ومخالفة القوانين (3/3).`,
                                    mentions: [sender]
                                });
                            } else {
                                await sock.sendMessage(from, {
                                    text: `⚠️ @${senderNumber} يكرر إرسال الروابط! يرجى طرده.`,
                                    mentions: [sender]
                                });
                            }
                            ...
                            await sock.sendMessage(from, {
                                text: `⚠️ ممنوع إرسال الروابط يا @${senderNumber}! تم حذف الرسالة. التحذير رقم (${warnings}/3).`,
                                mentions: [sender]
                            });
                        }
                        return; 
